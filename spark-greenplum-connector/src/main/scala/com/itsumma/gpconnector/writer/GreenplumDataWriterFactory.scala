...
class GreenplumDataWriterFactory(writeUUID: String, schema: StructType, saveMode: SaveMode,
                                 optionsFactory: GPOptionsFactory, nGpSegments: Int, rmiRegistry: String)
...
*/
    ...
    new GreenplumDataWriter(writeUUID, schema, saveMode, optionsFactory, partitionId, taskId, epochId, nGpSegments, rmiRegistry)
  }
}
